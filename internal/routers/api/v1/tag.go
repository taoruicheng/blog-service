...
import (
	...
	"github.com/taoruicheng/blog-service/internal/service"
	"github.com/taoruicheng/blog-service/pkg/app"
	"github.com/taoruicheng/blog-service/pkg/convert"
...
// @Summary 新增标签
// @Produce  json
// @Param body body service.CreateTagRequest true "JSON数据"
